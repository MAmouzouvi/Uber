...
public class DriverRegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(DriverRegisterActivity.this,"You can register now", Toast.LENGTH_LONG).show();
        ...
        nRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(firstName)){
                    Toast.makeText(DriverRegisterActivity.this,"Please Enter your first name", Toast.LENGTH_LONG).show();
                    nFistName.setError("First Name is required");
                    nFistName.requestFocus();

                } else if (TextUtils.isEmpty(lastName)){
                    Toast.makeText(DriverRegisterActivity.this,"Please Enter your last name", Toast.LENGTH_LONG).show();
                    nLastName.setError("Last Name is required");
                    nLastName.requestFocus();
                } else if (TextUtils.isEmpty(email)){
                    Toast.makeText(DriverRegisterActivity.this,"Please Enter your email address", Toast.LENGTH_LONG).show();
                    nEmail.setError("email is required");
                    nEmail.requestFocus();

                } else if (TextUtils.isEmpty(password)){
                    Toast.makeText(DriverRegisterActivity.this,"Please Enter a password", Toast.LENGTH_LONG).show();
                    nPassword.setError("Password is required");
                    nPassword.requestFocus();

                }else if(password.length() <= 5){
                    Toast.makeText(DriverRegisterActivity.this,"Please enter a longer password", Toast.LENGTH_LONG).show();
    ...
    private void registerUser(String firstName, String lastName, String email, String password) {
        ...
        // register user
        auth.createUserWithEmailAndPassword(email,password).addOnCompleteListener(DriverRegisterActivity.this, new OnCompleteListener<AuthResult>() {
            @Override
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(task.isSuccessful()){
                    ...
                    DatabaseReference referenceProfile = FirebaseDatabase.getInstance().getReference("Registers Users").child("Drivers");
                    referenceProfile.child(firebaseUser.getUid()).setValue(writeUserDetails).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if(task.isSuccessful()){
                                ...
                                Toast.makeText(DriverRegisterActivity.this, "Account successfully created. Please very email in inbox", Toast.LENGTH_LONG).show();


//                    // open user profile after successful registration
//
                    Intent intent = new Intent(DriverRegisterActivity.this, DriverProfileActivity.class);
                    ...
                    finish();   // to Close Register Activity
                                ...
                                Toast.makeText(DriverRegisterActivity.this, "User registration failed. Please try againx", Toast.LENGTH_LONG).show();
                            }
                    ...
                    try{
                        ...
                        Toast.makeText(DriverRegisterActivity.this,e.getMessage(),Toast.LENGTH_LONG).show();
